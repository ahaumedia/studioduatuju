      ...
      <div class="col-md-12 order-md-2">
        ...
        <br/>
          <div class="row text-center">
            ...
            <div class="col"><a href="portfolio.php?main=Heroes_Music&sub=Soundtrack_Works">
              <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="300" height="450" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 250x250" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"/><text x="50%" y="50%" fill="#666" dy=".3em" font-size="24">Music for Film</text></svg></a>
            </div>
            <div class="col">
